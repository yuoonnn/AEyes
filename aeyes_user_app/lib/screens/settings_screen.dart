...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _saveSettings() async {
    ...
    try {
      ...
      setState(() {
        successMessage = l10n.settingsSaved;
        isLoading = false;
      });
        ...
        body: ListView(
          ...
          children: [
            ...
            _buildSectionCard(
              ...
              children: [
                ...
                _buildSettingItem(
                  ...
                  title: l10n.beepVolume,
                  subtitle: l10n.boneConductionSpeaker,
                  trailing: SizedBox(
                    width: 150,
                    child: Slider(
                      value: beepVolume,
            ...
            _buildSectionCard(
              ...
              children: [
                _buildSettingItem(
                  ...
                  subtitle: l10n.enablePushNotifications,
                  trailing: Switch(
                ...
                _buildSettingItem(
                  ...
                  title: l10n.darkMode,
                  subtitle: l10n.switchBetweenThemes,
                  trailing: Switch(
                    value: isDarkMode,
                    activeColor: green,
                    onChanged: (val) {
            ...
            Padding(
              ...
              child: CustomButton(
                label: isLoading ? 'Saving...' : l10n.saveSettings,
